...
<html>
	...
	<body>
		<a href="#edit-sec" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-sec" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:secInstance, action:'update']" method="PUT" >
