...
<html>
	...
	<body>
		<a href="#edit-fri" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-fri" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:friInstance, action:'update']" method="PUT" >
