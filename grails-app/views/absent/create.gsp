...
<html>
	...
	<body>
		<a href="#create-absent" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-absent" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:absentInstance, action:'save']" >
				<fieldset class="form">
