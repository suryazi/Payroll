...
<html>
	...
	<body>
		<a href="#edit-ded" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-ded" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:dedInstance, action:'update']" method="PUT" >
