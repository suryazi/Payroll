...
<html>
	<head>
		...
		<g:set var="entityName" value="${message(code: 'fri.label', default: 'Friday')}" />
	...
	<body>
		<asset:script type="text/javascript">
			function linkShowIdFormat(cellvalue, options, rowObject){
				...
				return "<a href='/payroll/fri/show/" + cellvalue + "'>" + cellvalue + "</a> ";
			}
			...
			function linkShowLoanIdFormat(cellvalue, options, rowObject){
				//format the id cell value to new format so that it will show the corresponding details.
				return "<a href='/payroll/loan/show/" + cellvalue + "'>" + cellvalue + "</a> ";
			}
		...
		<div class="col-md-10 row-fluid">
			<div id="grid-div" class="content scaffold-grid" role="main">
				...
				<grid:grid id='jqgridinitial' name='dedJQ'>
				    ...
				    <grid:set col="loan" formatter='f:linkShowLoanIdFormat' unformat="f:idUnFormat"/>
				</grid:grid>

				<grid:exportButton name='dedJQ'/>
